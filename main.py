...
def main():
    ...
    p1 = Processor(c, max_clock_sync_error, 8, Processor.ATTENDANCE_LIST_PROTOCOL)
    p2 = Processor(c, max_clock_sync_error, 8, Processor.ATTENDANCE_LIST_PROTOCOL)
    p3 = Processor(c, max_clock_sync_error, 8, Processor.ATTENDANCE_LIST_PROTOCOL)
    p4 = Processor(c, max_clock_sync_error, 8, Processor.ATTENDANCE_LIST_PROTOCOL)
    p5 = Processor(c, max_clock_sync_error, 8, Processor.ATTENDANCE_LIST_PROTOCOL)
    ...
    time.sleep(3 * (broadcast_delay + max_clock_sync_error) + 6)
    print(p1)
    print(p2)
    print(p3)
    print(p4)
